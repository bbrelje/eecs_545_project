...
for i_array, arr in enumerate(arrays):
    ...
    for sm_ind, this_sm in enumerate(all_sms):
        ...
        for j in range(test_set.shape[0]):
            ...
            err_sum += np.abs((fuelburn_true - predictions[0,0]))
        avg_err = err_sum / test_set.shape[0]
        err[i_array, sm_ind] = avg_err

print('Avg abs error for fuel burn: '+str(np.mean(err, axis=0)))
# Avg abs error for fuel burn: [0.00703007 0.00042479 0.00042339 0.00091225 0.03080922 0.087983
#  0.00642129]